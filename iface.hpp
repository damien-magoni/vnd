...
*/	
	...
	class input_hold_queue : public hold_queue
	{
	public:
		input_hold_queue(boost::asio::io_service * io_serv);
		~input_hold_queue();
		std::string print_id();
	...
	class output_hold_queue : public hold_queue
	{
	public:
		output_hold_queue(boost::asio::io_service * io_serv);
		~output_hold_queue();
		std::string print_id();
		void wait(frame * f);
		void handle_wait(const boost::system::error_code & ec, frame * f);
	...
	public:
		...
		input_hold_queue * input_queue;
		output_hold_queue * output_queue;
